...
public class Waves : MonoBehaviour
{
    ...
    void Update()
    {
        // Prevents waves that are supposed to peak into camera range from not rendering.
        Component[] waveMeshFilters = GetComponentsInChildren<MeshCollider>();
        foreach (MeshCollider filter in waveMeshFilters)
        {
